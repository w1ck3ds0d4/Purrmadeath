            ...
            if (message.type === 'snapshot') {
                ...
                serverPerf = message.serverPerf && typeof message.serverPerf === 'object'
                    ? {
                        ...
                        towerProjectileDamageApplied: Number(message.serverPerf.towerProjectileDamageApplied) || 0,
                        towerProjectileEnemyHits: Number(message.serverPerf.towerProjectileEnemyHits) || 0,
                        enemyMeleeDamageApplied: Number(message.serverPerf.enemyMeleeDamageApplied) || 0,
                        enemyMeleePlayerHits: Number(message.serverPerf.enemyMeleePlayerHits) || 0,
                        enemyMeleeCivilianHits: Number(message.serverPerf.enemyMeleeCivilianHits) || 0,
                        authoritySnapshotAgeMs: Number(message.serverPerf.authoritySnapshotAgeMs) || 0,
                        combatFrozenBySnapshotStall: Number(message.serverPerf.combatFrozenBySnapshotStall) || 0,
                        combatFreezeTicks: Number(message.serverPerf.combatFreezeTicks) || 0,
                        droppedQueuedEnemyHits: Number(message.serverPerf.droppedQueuedEnemyHits) || 0,
                        aiDirectiveMsAvg: Number(message.serverPerf.aiDirectiveMsAvg) || 0,
                        aiDirectiveBudgetMs: Number(message.serverPerf.aiDirectiveBudgetMs) || 0,
                        aiDirectiveOverBudgetTicks: Number(message.serverPerf.aiDirectiveOverBudgetTicks) || 0,
