...
export const RANGER_BRANCHES: Record<string, SkillBranch> = {
  sharpshooter: {
    ...
    nodes: [
      ...
      { id: 'sharpshooter_t5', tier: 5, branch: 'sharpshooter', name: 'Sniper Shot', description: 'Charge 2s, fire massive arrow dealing 500% damage. 30s CD',
        active: { abilityId: 'sniper_shot', name: 'Sniper Shot', description: 'Charge 2s, fire massive 500% damage arrow', cooldown: 30,
          params: { type: 'sniper_shot', chargeTime: 2, damageMultiplier: 5.0 } } },
    ...
    nodes: [
      ...
      { id: 'trapper_t5', tier: 5, branch: 'trapper', name: 'Explosive Barrage', description: 'Fire 5 explosive arrows in a spread, each exploding for 80 dmg in 60px. 25s CD',
        active: { abilityId: 'explosive_barrage', name: 'Explosive Barrage', description: 'Fire 5 explosive arrows', cooldown: 25,
          params: { type: 'explosive_barrage', arrowCount: 5, damagePerArrow: 80, explosionRadius: 60 } } },
